...
export default function Career() {
  return (
    ...
    <Card sx={{ display: 'flex', maxWidth: 345, minWidth: 390, minHeight: 137, '@media (max-width: 950px)': { minHeight: 150 }, '@media (max-width: 550px)': { minWidth: 355 }, '@media (max-width: 418px)': { minHeight: 135, minWidth: 285 }}}>
    <CardActionArea>
      {/* <CardMedia
        component="img"
        alt="Recent Project"
