...
export default function MediaControlCard() {
  ...
  return (
    ...
    <Card sx={{ display: 'flex', maxWidth: 345, minWidth: 390, maxHeight: 150, '@media (max-width: 550px)': { minWidth: 355 }, '@media (max-width: 418px)': { minHeight: 210, minWidth: 240, maxWidth:230 } }}>
      ...
      <CardMedia
        component="img"
        sx={{ width: 151, '@media (max-width: 450px)': { width: 250 } }}
