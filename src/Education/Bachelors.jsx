...
const Education = () => {
  ...
  return (
    <div className="card-b">
        ...
        <p className="school">Dallas Baptist University, 3.95</p>

        <p className="front_description">Earned a Bachelor's degree in Cyber Security while being a student ahlete and Teacher's Assiasant</p>
